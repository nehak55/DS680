...
## Introduction
This is a traditional conjoint analysis R Markdown document.
The attributes in this demonstartion are: mobile provider, startup and monthly costs, if the provider offers 4G services in the area, whether the retailer has a retail location nearby also whether the provider supports Apple, Samsung or Nexus phones.
...
load(file="/Users/neha/Documents/marketing/MDS_Chapter_1/mtpa_spine_chart.Rdata")
```
...
## Parth-worth, standardized parth worth and attribute importance
```{r}
